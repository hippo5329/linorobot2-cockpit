...
// BNO085 dynamic tare and calibration. Serial, initBoard() and the radio are the
...
extern "C" void bno085_cal_setup(void) { bno085_cal::setup_(); }
extern "C" void bno085_cal_loop(void)  { bno085_cal::loop_(); }
