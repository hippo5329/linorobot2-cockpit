...
// USE_MPU6050_IMU or USE_FAKE_IMU, and imu.h turned that into `#define IMU
// <class>`. One robot, one binary, and a bench board running fake sensors
...
//     imu=fake        mag=fake          the same binary on a bare bench
//
...
//
// An unknown or empty name falls back to the fake driver rather than failing to
